...
| `fps_value=`                       | Choose the break points where `fps_color_change` changes colors at. E.g `30,50,60`, default is `30,60` |
...
| `horizontal_strech`                | Stretches the background to the screens width in `horizontal` mode                    |
...
| `mangoapp_steam`                   | Enables mangoapp to be displayed above the Steam UI                                   |
